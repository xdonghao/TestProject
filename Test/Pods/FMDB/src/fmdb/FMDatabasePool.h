...
- (BOOL)databasePool:(FMDatabasePool*)pool cc_shouldAddDatabaseToPool:(FMDatabase*)database;
...
- (void)databasePool:(FMDatabasePool*)pool cc_didAddDatabase:(FMDatabase*)database;
